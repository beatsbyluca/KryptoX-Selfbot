...
aniket72 = commands.Bot(description='KryptoX ',
                           command_prefix='+',
                           self_bot=True,
                           intents=intents)
status_task = None
...
async def link(channel):
    await channel.send("- `https://discord.gg/boostparadise`")
